...
@section('content')
    <div class="row">
        <div class="col-sm-8 offset-sm-2">
            <h1 class="display-3">Add Host IP</h1>
            <div>
                @if ($errors->any())
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('host_ip.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="39" class="form-control" name="ip_address"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="39" class="form-control" name="gateway"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="12" class="form-control" name="mac_address"/>
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary">Add Host IP</button>
                            <form>
