...
@section('content')
    <div class="row">
        <div class="col-sm-8 offset-sm-2">
            <h1 class="display-3">Edit Service instance param</h1>
            @if ($errors->any())
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('service_instance_param.update', $service_instance_param->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="250" class="form-control" name="param_name" value="{{ $service_instance_param->param_name }}"/>
                        </div>
                        <div class="form-group">
                            <label for="param_value">Param value:</label>
                            <input type="text" maxlength="250" class="form-control" name="param_value" value="{{ $service_instance_param->param_value }}"/>
                        </div>
