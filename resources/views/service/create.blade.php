...
@section('content')
    <div class="row">
        <div class="col-sm-8 offset-sm-2">
            <h1 class="display-3">Add Service</h1>
            <div>
                @if ($errors->any())
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('service.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="50" class="form-control" name="daemon_name"/>
                            </div>
                            <div class="form-group">
                                <label for="protocol">Protocol: </label>
                                <input type="text" maxlength="20" class="form-control" name="protocol"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select id="service_group_id" name="service_group_id" class="select2ex form-control">
                                    <option disabled value="" selected>Service group name</option>
